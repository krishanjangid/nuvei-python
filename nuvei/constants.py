"""Shared constants: supported currencies, country codes, locales."""
...
CURRENCIES: frozenset[str] = frozenset({
    ...
    "BIF", "BMD", "BND", "BOB", "BRL", "BSD", "BTN", "BWP", "BYN", "BYR", "BZD", "CAD", "CDF", "CHF", "CLP",
    "CNY", "COP", "CRC", "CUP", "CVE", "CYP", "CZK", "DJF", "DKK", "DOP", "DZD", "EEK", "EGP", "ERN", "ETB",
    ...
    "NAD", "NGN", "NIO", "NIS", "NOK", "NPR", "NZD", "OMR", "PAB", "PEN", "PGK", "PHP", "PKR", "PLN", "PYG",
    "QAR", "RMB", "RON", "RSD", "RUB", "RWF", "SAR", "SBD", "SCR", "SDG", "SEK", "SGD", "SHP", "SLL", "SOS",
    "SPL", "SRD", "SSP", "STD", "SVC", "SYP", "SZL", "THB", "TJS", "TMM", "TND", "TOP", "TRY", "TTD", "TVD",
    "TWD", "TZS", "UAH", "UGX", "USD", "UYU", "UZS", "VEF", "VND", "VUV", "WST", "XAF", "XAG", "XAU", "XCD",
    "XDR", "XOF", "XPD", "XPF", "XPT", "YEN", "YER", "ZAR", "ZMK", "ZWD",
})

LOCALES: frozenset[str] = frozenset({
    "ar_AA", "bg_BG", "cs_CZ", "cz_CZ", "da_DK", "de_DE", "de_de", "el_GR",
    "en_AU", "en_CA", "en_EN", "en_UK", "en_US", "es_ES", "fi_FI", "fr_FR",
    "hr_HR", "hu_HU", "in_ID", "it_IT", "iw_IL", "ja_JP", "ko_KR", "lt_LT",
    "nl_NL", "no_NO", "pl_PL", "pt_BR", "pt_PT", "ro_RO", "ru_RU", "sk_SK",
    "sl_SI", "sl_SL", "sq_AL", "sr_RS", "sv_SE", "tr_TR", "vi_VN", "zh_CN",
    "zh_TW",
})
